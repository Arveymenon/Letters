...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmailStringValidatorDirective", function() { return EmailStringValidatorDirective; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _Services_Toast_toast_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../Services/Toast/toast.service */ "./src/app/Shared/Services/Toast/toast.service.ts");



let EmailStringValidatorDirective = class EmailStringValidatorDirective {
    constructor(toast) {
        this.toast = toast;
...
EmailStringValidatorDirective.ctorParameters = () => [
    { type: _Services_Toast_toast_service__WEBPACK_IMPORTED_MODULE_2__["ToastService"] }
];
EmailStringValidatorDirective.propDecorators = {
    control: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"], args: ['formControl',] }],
    emailValidation: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"], args: ['change', ["$event"],] }]
};
EmailStringValidatorDirective = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
InputComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-input',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./input.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/login/components/input/input.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./input.component.scss */ "./src/app/pages/login/components/input/input.component.scss")).default]
    })
], InputComponent);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _components_input_input_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/input/input.component */ "./src/app/pages/login/components/input/input.component.ts");
...
/* harmony import */ var src_app_Shared_Directives_EmailStringValidator_email_string_validator_directive__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/Shared/Directives/EmailStringValidator/email-string-validator.directive */ "./src/app/Shared/Directives/EmailStringValidator/email-string-validator.directive.ts");
...
LoginPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        declarations: [
            _login_page__WEBPACK_IMPORTED_MODULE_7__["LoginPage"],
            _components_input_input_component__WEBPACK_IMPORTED_MODULE_1__["InputComponent"],
            src_app_Shared_Directives_EmailStringValidator_email_string_validator_directive__WEBPACK_IMPORTED_MODULE_9__["EmailStringValidatorDirective"]
        ]
    })
], LoginPageModule);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _Shared_Services_Authentication_auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../../Shared/Services/Authentication/auth.service */ "./src/app/Shared/Services/Authentication/auth.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var src_app_Shared_Services_Loader_loading_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/Shared/Services/Loader/loading.service */ "./src/app/Shared/Services/Loader/loading.service.ts");
...
/* harmony import */ var vara__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! vara */ "./node_modules/vara/src/vara.min.js");
/* harmony import */ var vara__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(vara__WEBPACK_IMPORTED_MODULE_7__);
...
let LoginPage = class LoginPage {
    constructor(auth, router, loader, toast) {
        this.auth = auth;
        this.router = router;
        this.loader = loader;
        this.toast = toast;
    ...
    authenticate() {
        this.loader.create();
        this.auth.login(this.email.value, this.randomOtp).then((user) => {
            this.loader.dismiss();
            this.user = user;
            this.loginStage = 2;
        });
