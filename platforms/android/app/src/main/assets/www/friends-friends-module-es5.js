    ...
    function srcAppPagesFriendsFriendsPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var FriendsPage = /*#__PURE__*/function () {
        ...
        _createClass(FriendsPage, [{
          ...
          key: "viewLetters",
          value: function viewLetters() {
            this.router.navigateByUrl('friends/letters'); // this.router.navigateByUrl('view-profile')
          }
        }]);
